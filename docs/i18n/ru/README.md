...
NOFX поддерживает несколько провайдеров AI-моделей. Подключайте DeepSeek, OpenAI, Google и других со своим API-ключом или используйте любой OpenAI-совместимый эндпоинт (включая self-hosted).
...
| **Доступ к AI-моделям** | Несколько провайдеров с вашими API-ключами (включая OpenAI-совместимые эндпоинты) |
