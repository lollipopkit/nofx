...
NOFX підтримує кількох провайдерів AI-моделей. Підключайте DeepSeek, OpenAI, Google та інших зі своїм API-ключем або використовуйте будь-який OpenAI-сумісний ендпоінт (зокрема self-hosted).
...
| **Доступ до AI-моделей** | Кілька провайдерів з вашими API-ключами (зокрема OpenAI-сумісні ендпоінти) |
