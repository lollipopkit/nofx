...
NOFX는 여러 AI 모델 제공업체를 지원합니다. DeepSeek, OpenAI, Google 등에 자신의 API 키로 연결하거나, 임의의 OpenAI 호환 엔드포인트(셀프 호스팅 포함)를 사용할 수 있습니다.
...
| **AI 모델 액세스** | 자신의 API 키로 여러 제공업체 연결(OpenAI 호환 엔드포인트 지원) |
