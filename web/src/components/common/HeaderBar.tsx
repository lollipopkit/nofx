            ...
            {isLoggedIn && user ? (
              <div className="flex items-center gap-3">
                ...
                <div className="relative" ref={userDropdownRef}>
                  ...
                  >
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold bg-nofx-gold text-white">
                  ...
                  {userDropdownOpen && (
                    <div className="absolute right-0 top-full mt-2 w-48 rounded-lg shadow-lg overflow-hidden z-50 bg-nofx-bg-lighter border border-nofx-gold/20">
                      ...
                      >
                        <Settings className="w-3.5 h-3.5" />
                        {userMode === 'beginner'
                          ? pick(language, '切换到高级模式', 'Switch to Advanced', 'Beralih ke Lanjutan')
                          : pick(language, '切换到新手模式', 'Switch to Beginner', 'Beralih ke Pemula')}
                      </button>
                      {onLogout && (
                        <button
                          onClick={() => {
